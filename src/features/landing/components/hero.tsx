            ...
            <div className="gap-12 grid grid-cols-1 lg:grid-cols-12 mx-auto w-full max-w-4xl">
                <div className="flex flex-col justify-center lg:col-span-8">
                    ...
                    <p className="mb-10 max-w-2xl font-light text-muted-foreground text-xl md:text-2xl leading-relaxed transition-colors duration-500">
                        ...
                        with <span className="font-normal text-primary">3+ years of experience</span> building fast, accessible interfaces with React, Next.js & TypeScript, from custom ecommerce development to AI automation. Available for remote roles and client projects worldwide.
                    </p>
